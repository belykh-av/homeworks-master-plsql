CREATE OR REPLACE PACKAGE ut_payment_api_pack is
  ...
  --%throws(common_pack.c_error_code_empty_field_id)
  ...
  --%throws(common_pack.c_error_code_empty_payment_details)
  ...
  --%throws(common_pack.c_error_code_empty_payment_id)
  ...
  --%throws(common_pack.c_error_code_payment_not_found)
  ...
  --%beforetest(ut_common_pack.get_payment_in_no_created_status)
  --%throws(common_pack.c_error_code_payment_in_final_status)
  ...
  --%beforetest(ut_common_pack.create_default_payment)
  --%throws(common_pack.c_error_code_empty_status_change_reason)
  ...
  --%throws(common_pack.c_error_code_payment_api_restriction)
  ...
  --%beforetest(ut_common_pack.create_default_payment)
  --%throws(common_pack.c_error_code_deleting_restriction)
